...
구분 없이 추적하는 최신 모델 9개의 공식 원문을 Browser에서 확인했습니다. 공개 가중치의 기본 크기 기준은 총 120B 이하이지만, `K-EXAONE 2.0 A37B`는 활성 규모를 대표 이름으로 쓰는 명시적 size exception입니다. A37B는 토큰당 약 37B active parameter이며 실제 total은 750B입니다. gpt-oss-120b/20b는 2025-08-05 공개된 별도 참고 기준선으로 조사했으며 추적 matrix와 채움률 통계에서는 제외했습니다.
...
추가·전문화 표와 gpt-oss 참고표의 수치는 version, subset 또는 출시 기간이 달라 통합 행렬 분모에서 제외했습니다. 추적 대상에서 모든 행이 빈 benchmark 열은 제거했습니다.
...
| 상태 | 정확한 모델/체크포인트 | 공개일 | Browser 확인 원문 | 카드/보고서 상태 |
| :--- | :--- | :---: | :--- | :--- |
| Tracked | `Qwen/Qwen3.8-27B` | 2026-08-13 weight commit | [고정 카드](https://huggingface.co/Qwen/Qwen3.8-27B/blob/1d4bf0f2ff6012fd82039f2fa52739d0dd7c60c0/README.md) · [첫 전체 weight 커밋](https://huggingface.co/Qwen/Qwen3.8-27B/commit/72a217afab8029b39e4af1c7273a829995a3dbaf) | owner card/weights 확인 |
| Tracked | Grok 4.6 (`grok-4.6`) | 2026-08-12 | [xAI 발표·평가표](https://x.ai/news/grok-4-6) · [모델 문서](https://docs.x.ai/developers/models/grok-4.6) | 별도 공식 model card/tech report는 2026-08-19 현재 발견하지 못함 |
| Tracked · **size exception** | `LGAI-EXAONE/K-EXAONE-2.0-750B-A37B` | 2026-07-31 | [LG 공식 출시 보도](https://www.lgresearch.ai/news/view?seq=678) · [LG 공식 출시 연혁](https://github.com/LG-AI-EXAONE/K-EXAONE-2.0) · [고정 owner card](https://huggingface.co/LGAI-EXAONE/K-EXAONE-2.0-750B-A37B/blob/b159206982abe02813dae76f0bd568dbd3d4f53f/README.md) · [첫 전체 weight 커밋](https://huggingface.co/LGAI-EXAONE/K-EXAONE-2.0-750B-A37B/commit/b159206982abe02813dae76f0bd568dbd3d4f53f) · [기술 보고서 v1](https://arxiv.org/html/2608.04505v1) | 최신 general-purpose EXAONE · owner card(BF16) · report(Reasoning) · 총 750B 예외 |
| Tracked | Claude Opus 5 (`claude-opus-5`) | 2026-07-24 | [Anthropic 발표](https://www.anthropic.com/news/claude-opus-5) · [System Card landing](https://www.anthropic.com/claude-opus-5-system-card) · [고정 PDF](https://www-cdn.anthropic.com/b514064af1408018e64b1ad24e7d5e75850b4ffd/Claude%20Opus%205%20System%20Card.pdf) | 공식 System Card 확인 |
| Tracked | `inclusionAI/LLaDA2.2-flash` | 2026-07-16 | [고정 카드](https://huggingface.co/inclusionAI/LLaDA2.2-flash/blob/ee56264534721014d8e651293543f6dc3fcb1f9c/README.md) · [고정 기술 보고서 PDF](https://raw.githubusercontent.com/inclusionAI/LLaDA2.X/f402f0b52817e1c3586a024ebf89e69ad8ca5523/LLaDA2_2_tech_report.pdf) | owner card/report 확인 |
| Tracked | GPT-5.6 Sol (`gpt-5.6-sol`) | 2026-07-09 GA | [6/26 preview](https://openai.com/index/previewing-gpt-5-6-sol/) · [7/9 발표·평가표](https://openai.com/index/gpt-5-6/) · [System Card](https://deploymentsafety.openai.com/gpt-5-6) · [고정 PDF](https://deploymentsafety.openai.com/gpt-5-6/gpt-5-6.pdf) · [API 문서](https://developers.openai.com/api/docs/models/gpt-5.6-sol) | 발표 표와 System Card 확인 |
| Tracked | `google/diffusiongemma-26B-A4B-it` | 2026-06-10 | [고정 카드](https://huggingface.co/google/diffusiongemma-26B-A4B-it/blob/f7f5b7f5fa82ffc52addd066915886d497f5517b/README.md) · [Google 출시](https://blog.google/innovation-and-ai/technology/developers-tools/diffusion-gemma-faster-text-generation/) | owner card/blog 확인 |
| Tracked | `google/gemma-4-31B-it` | 2026-04-02 | [고정 카드](https://huggingface.co/google/gemma-4-31B-it/blob/842da3794eaa0b77d5f08bae87a17459d91ff475/README.md) · [Google 출시](https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/) · [기술 보고서 v2](https://arxiv.org/html/2607.02770v2) | owner card/report 확인 |
| Tracked | Gemini 3.1 Pro Preview (`gemini-3.1-pro-preview`) | 2026-02-19 | [DeepMind Model Card](https://deepmind.google/models/model-cards/gemini-3-1-pro/) · [고정 Model Card PDF](https://storage.googleapis.com/deepmind-media/Model-Cards/Gemini-3-1-Pro-Model-Card.pdf) · [평가 방법론 PDF](https://storage.googleapis.com/deepmind-media/gemini/gemini_3-1_pro_model_evaluation.pdf) | 공식 카드·방법론 확인 |
...
공개 가중치 체크포인트의 `artifact` 정수는 고정 revision Hugging Face API 응답의 `safetensors.total`을 사용했습니다. gpt-oss는 OpenAI 모델 카드 Table 1의 exact total/active parameter와 checkpoint-size 값을 사용했습니다.
...
## [추적 모델 9개](./README.md#tracked-benchmarks) — 통합 표 provenance

| 모델 | 통합 표 채택값 | 근거와 핵심 설정 |
| :--- | :--- | :--- |
| Qwen3.8-27B | SWE Pro refined **61.7**; DeepSWE 1.1 **42.2**; Terminal-Bench 2.1 **73.0**; LCB v6 **90.3**; IFBench **79.5**; GPQA-D **89.2**; HLE **30.8** | [고정 owner card](https://huggingface.co/Qwen/Qwen3.8-27B/blob/1d4bf0f2ff6012fd82039f2fa52739d0dd7c60c0/README.md). SWE Pro/DeepSWE=Claude Code; SWE Pro는 refined set. Terminal·LCB·IF·GPQA의 mode/tools/trials 일부 미공개. HLE=GPT-4o judge. |
...
| K-EXAONE 2.0 A37B | SWE-V **68.2**; Terminal-Bench 2.1 **43.8**; IFBench **72.6**; GPQA-D **82.2**; HLE text-only **18.3**; MMLU-Pro **83.5** | [고정 owner card BF16 열](https://huggingface.co/LGAI-EXAONE/K-EXAONE-2.0-750B-A37B/blob/b159206982abe02813dae76f0bd568dbd3d4f53f/README.md) · [report Table 6](https://arxiv.org/html/2608.04505v1#S6.T6) · [Appendix C](https://arxiv.org/html/2608.04505v1#A3). report의 K-EXAONE 2.0 Reasoning 첫 열. SWE=mini-SWE-agent; Terminal=Terminus-2. temp1/top-p.95, 32,768 tokens/step, 256K, 4h; trials 일부 미공개. |
...
| LLaDA2.2-flash | SWE-V **49.28**; SWE Pro **30.10**; BFCL v4 **60.78**; IFBench **30.20**; GPQA-D **48.67** | [owner card](https://huggingface.co/inclusionAI/LLaDA2.2-flash/blob/ee56264534721014d8e651293543f6dc3fcb1f9c/README.md) · [report PDF](https://raw.githubusercontent.com/inclusionAI/LLaDA2.X/f402f0b52817e1c3586a024ebf89e69ad8ca5523/LLaDA2_2_tech_report.pdf). 전 값 5회 평균; SWE=Claude Code. 128K, temp1, block32, threshold.5, editing threshold0. SWE Pro subset 및 BFCL/IF/GPQA 세부 일부 미공개. |
...
| DiffusionGemma 26B-A4B-IT | τ² avg **56.2**; LCB v6 **69.1**; GPQA-D **73.2**; HLE **11.0/11.9**; MMLU-Pro **77.6**; MMMU-Pro **54.3** | [owner card](https://huggingface.co/google/diffusiongemma-26B-A4B-it/blob/f7f5b7f5fa82ffc52addd066915886d497f5517b/README.md). Entropy-Bound sampler, max48 denoise, temp .8→.4, entropy bound .1, adaptive stop. HLE no-tools/search 분리; shots/pass@k/trials 일부 미공개. |
| Gemma 4 31B-IT | τ² avg **76.9**; LCB v6 **80.0**; IFBench **76.0**; GPQA-D **84.3**; HLE **19.5/26.5**; MMLU-Pro **85.2**; MMMU-Pro **76.9** | [owner card](https://huggingface.co/google/gemma-4-31B-it/blob/842da3794eaa0b77d5f08bae87a17459d91ff475/README.md) · [report](https://arxiv.org/html/2607.02770v2). IT 모델, 기본 thinking. HLE no-tools/search 분리. per-benchmark decoder/trials 일부 미공개. |
...
gpt-oss의 나머지 추가값은 [OpenAI Model Card Table 3·9·10](https://arxiv.org/html/2508.10925v1)에서 추출했습니다. Table 3은 high reasoning이며 AIME/GPQA/HLE/Codeforces의 no-tools/tools를 분리했습니다. Table 9·10의 SimpleQA/PersonQA/BBQ는 effort 미공개이고, 원문 proportion을 ×100으로 환산했으며 SimpleQA/PersonQA는 no browsing입니다. accuracy와 hallucination rate, BBQ ambiguous/disambiguated accuracy도 각각 분리했습니다.

## [추가 공식 결과](./README.md#additional-results) — provenance
...
| Gemma 4 `Terminal-Bench Hard 36.0`을 통합 Terminal-Bench 열에 사용 | 제외 | Hard variant는 다른 모델의 v2.0/v2.1/v3.0 결과와 exact variant가 아니므로 추가 결과에만 보존. |
